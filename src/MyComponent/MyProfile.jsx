              ...
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  ...
                  <div class="mt-3">
                    ...
                    <p class="text-secondary mb-1">Full Stack Driver</p>
                    <p class="text-muted font-size-sm">Indore india</p>
                    <button class=" me-2 btn btn-primary">Update Pic</button>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">sj2585097@gmail.com</div>
                  </div>
                  <hr/>
                  <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary">9131649079</div>
                  </div>
                  <hr/>
                  <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary">610 hinauttiya alam olar roasd bhopal mp</div>
                  </div>
                  <hr/>
                  <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="card h-100">
                      <div class="card-body">
                        ...
                        <small>Website Markup</small>
                          <div class="progress mb-3">
                            <div class="progress-bar bg-primary" role="progressbar"  style={{width:'70%',backgroundColor:'red'}} aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        <small>Website Markup</small>
                          <div class="progress mb-3">
                        ...
                        <small>One Page</small>
                          <div class="progress mb-3">
                            <div class="progress-bar bg-primary" role="progressbar" style={{width:'90%'}}  aria-valuenow="89" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                      </div>
                    </div>
                  </div>
